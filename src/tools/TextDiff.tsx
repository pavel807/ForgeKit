    ...
    <ToolPage
      ...
      toolbar={
        <label className="fk-checkbox" style={{ fontSize: 13 }}>
          ...
          <span>Игнорировать регистр</span>
        </label>
      }
      statusLeft={<span>LCS-сравнение построчно (ядро Rust)</span>}
    ...
    >
      <div className="diff-grid">
        ...
        <div className="diff-result" style={{ gridColumn: "1 / -1" }}>
          {lines.length === 0 && <div style={{ color: "var(--text-tertiary)", textAlign: "center", paddingTop: 40 }}>Тексты идентичны</div>}
          {lines.map((l, i) => (
