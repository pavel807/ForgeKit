...
const dict = {
  ...
  "plg.sandboxed": { ru: "Плагин работает в песочнице без доступа к системе", en: "Plugin runs in a sandbox without system access" },
  "plg.loadError": { ru: "Не удалось открыть плагин", en: "Failed to open the plugin" },

  "mod.disabledTitle": { ru: "Модуль выключен", en: "Module is disabled" },
  "mod.disabledDesc": { ru: "Включите его в меню «Расширения», чтобы снова открыть", en: "Enable it in the Extensions menu to open it again" },
  "mod.openManager": { ru: "Открыть «Расширения»", en: "Open Extensions" },
  "mod.statusLeft": { ru: "Управление модулями и плагинами ForgeKit", en: "Manage ForgeKit modules and plugins" },
  "mod.installed": { ru: "Модулей: {a} из {b}", en: "Modules: {a} of {b}" },
  "mod.installTitle": { ru: "Плагины — пользовательские модули", en: "Plugins — user modules" },
  "mod.installDesc": { ru: "Установить плагин из папки или архива", en: "Install a plugin from a folder or archive" },
  "mod.installHint": { ru: "Плагин — папка с manifest.json и HTML-страницей, запускается в изолированной песочнице", en: "A plugin is a folder with manifest.json and an HTML page, running in an isolated sandbox" },
  "mod.fromFolder": { ru: "Из папки", en: "From folder" },
  "mod.fromZip": { ru: "Из архива", en: "From archive" },
  "mod.zipFilter": { ru: "Плагин ForgeKit", en: "ForgeKit plugin" },
  "mod.pluginsTitle": { ru: "Установленные плагины", en: "Installed plugins" },
  "mod.noPlugins": { ru: "Плагины не установлены", en: "No plugins installed" },
  "mod.noPluginsDesc": { ru: "Выберите папку плагина или архив .fkplugin", en: "Pick a plugin folder or a .fkplugin archive" },
  "mod.noDesc": { ru: "Без описания", en: "No description" },
  "mod.open": { ru: "Открыть", en: "Open" },
  "mod.remove": { ru: "Удалить", en: "Remove" },
  "mod.builtinTitle": { ru: "Встроенные модули", en: "Built-in modules" },
