...
Начиная с v1.5.1 приложение построено на модульной архитектуре: любой встроенный инструмент можно выключить (страница «Расширения»), а пользовательские модули устанавливаются в виде плагинов.
